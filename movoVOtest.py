...
img_relative_path = "data/sequence/"
pose_relative_path = "data/pose/pose.txt"
img_path = os.path.join(current_directory, img_relative_path)
pose_path = os.path.join(current_directory, pose_relative_path)

## We will probably need to change the focal and pp based on our camera (tbh i don't know how to do that)
focal = 718.8560
